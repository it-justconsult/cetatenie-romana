  ...
  <div>
    <div class='nav'>
      <div class='relative flex items-center justify-between'>
        <a
          :aria-label='content.logo.name' :title='content.logo.name' class='columns-2 items-center  w-48' href='/'>
        ...
        <ul class='menu-block flex hidden space-x-8 lg:flex'>
          <li
            ...
            class='relative'>
            <a
              :aria-label='item.title' :href='item.href'
              :title='item.title'
            ...
            <ul v-if='item.submenu' class='flex justify-end hidden lg:flex absolute'>
              <li v-for='sublink in item.submenu' :key='sublink.id'>
                <a
                  :aria-label='sublink.title' :href='sublink.href'
                  :title='sublink.title'
                  class='subnav font-medium tracking-wide text-gray-700 transition-colors duration-200 hidden hover:text-cetro-green'>{{
                    sublink.title
                  }}</a></li>
            </ul>
          </li>
